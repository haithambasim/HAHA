...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 2b62ffb3-3fe3-4c74-925c-675ed79bacbf
```

> `2b62ffb3-3fe3-4c74-925c-675ed79bacbf` is the password of the certificate, you can change it to any password you want.
...
The application needs a database. Run the following command in the `HAHA` directory to migrate the database and seed the initial data. This step is automatically done when you create a new solution, if you didn't especially disabled it.
